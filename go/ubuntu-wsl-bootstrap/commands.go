...
// getWorkingDir returns the scripts/ubuntu-wsl directory
// When running from ubuntu-wsl-bootstrap/, we need to go up one level
func getWorkingDir() string {
	...
	// Check if we're in ubuntu-wsl-bootstrap/ and need to go up
	if baseName == "ubuntu-wsl-bootstrap" {
